    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.OrganizationalUnits", t => t.OrganizationalUnitId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Employees", "OrganizationalUnitId", "dbo.OrganizationalUnits");
            ...
            DropIndex("dbo.Employees", new[] { "OrganizationalUnitId" });
